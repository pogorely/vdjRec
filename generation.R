...
estimate_pgen_aa<-function(data,V="TRBV9",J="TRBJ2-3",iter=3,nrec=5e5,cores=1,colname="CDR3.amino.acid.sequence"){
...
gen_beta<-function(n,V,J,pr=beta.prob,translate=T,inframe_only=T,segments=segmentsc2)
{
  tmp<-pr$P.ins.nucl[,1]
